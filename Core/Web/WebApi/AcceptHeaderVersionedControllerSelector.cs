...
namespace Core.Web.WebApi
{
    ...
    /// <summary>
    ///   Represents an <see cref="IHttpControllerSelector" /> implementation that supports versioning and 
    /// selects an controller based on versioning by convention (namespace.Api.Version1.xxxController). 
    ...
    public abstract class AcceptHeaderVersionedControllerSelector : VersionedControllerSelector
    {
        ...
        protected AcceptHeaderVersionedControllerSelector(HttpConfiguration configuration)
            : base(configuration)
        {
        }
