...
namespace Core
{
    ...
    public partial class CommonHelper
    {
        ...
        //public static byte[] Test(string password)
        //{
        //    var salt = "saltsalt";
        //    var iterations = 50000;
        //    return CryptSharp.Utility.Pbkdf2.ComputeDerivedKey(new HMACSHA512(Encoding.UTF8.GetBytes(password)), Encoding.UTF8.GetBytes(salt), iterations, 128);
        //}
        /// <summary>
