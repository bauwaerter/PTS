...
namespace Core
{
    ...
    public abstract class BaseEntity
    {
        ...
        public void CloneInfo(Object temp)
        {
            var fields = temp.GetType().GetFields(BindingFlags.Public | BindingFlags.Instance);
            foreach (var field in fields)
            {
                var value = field.GetValue(temp);// field.GetValue(temp);
